...
{
    public class MantenerDialog
    {
        private IDialogContext context;
        private LuisResult result;

        public MantenerDialog(IDialogContext context, LuisResult result)
        {
        ...
        public async Task StartAsync()
        {
            ...
            foreach (var entityP1 in result.Entities.Where(Entity => Entity.Type == "Pregunta::Palabra1"))
            {
                ...
                // ---------------------------------------------------------------------
                if (palabra1 == "cita" || palabra1 == "citas" || palabra1 == "reuniones" || palabra1 == "reunione")
                {
                    reply.Attachments = RespuestasOutlook.GetMantenerCitasYReuniones();
